...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div class="bg-white p-3.5 sm:p-4 rounded-2xl border border-amber-200 bg-amber-50/30 shadow-2xs min-w-0">
        ...
        <form method="GET" action="{{ route('adhocs.index') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <div>
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    @if (request()->hasAny(['category', 'urgency', 'approval_status', 'status', 'search']))
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    $isExpired = $endDate && $endDate->isPast() && $adhoc->floatActual < 100;
                        ...
                        <td class="px-4 py-3.5">
                            ...
                            @if ($adhoc->supervisor)
                            <div class="mt-1 text-[10px] text-gray-500 font-medium truncate" title="Supervisor: {{ $adhoc->supervisor->txtEmployeeName }}">
                        ...
                        <td class="px-4 py-3.5 text-center space-y-1">
                            ...
                            @else
                                ...
                                @endphp
                                <span class="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold border {{ $statusClass }} inline-block">
                                    {{ $status }}
                                </span>
                            @endif
                        </td>
